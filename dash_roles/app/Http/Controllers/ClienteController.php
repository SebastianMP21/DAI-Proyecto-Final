...
class ClienteController extends Controller
{
    ...
    public function index()
    {
        ...
        $clientes=DB::table('clientes')
            ->join('rentas', 'clientes.id', '=', 'rentas.id')   
            ->select('clientes.*', 'rentas.nombre')
            ->get();
    } 
    ...
    {
        //
        $this->validate($request,[ 'id'=>'required', 'nombre'=>'required', 'ap_paterno'=>'required', 'ap_materno'=>'required', 'fech_nac'=>'required']);
